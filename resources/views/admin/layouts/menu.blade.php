<div id="main-menu" class="main-menu collapse navbar-collapse">
    <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>quản lý người dùng</a>
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="fa fa-table"></i><a href="{{route('user.index')}}">Danh sách người dùng</a></li>
                    <li><i class="fa fa-table"></i><a href="{{route('nhom.index')}}">Danh sách nhóm</a></li>
                </ul>
            </li>
            <li class="menu-item-has-children dropdown">
